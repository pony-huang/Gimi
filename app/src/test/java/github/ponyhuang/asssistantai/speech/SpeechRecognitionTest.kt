...
import github.ponyhuang.asssistantai.ui.chat.appendTranscript
...
class SpeechRecognitionTest {
    ...
    @Test
    fun transcriptIsAppendedWithoutOverwritingDraft() {
        assertEquals("已有内容 新识别文本", appendTranscript("已有内容", " 新识别文本 "))
        assertEquals("新识别文本", appendTranscript("", "新识别文本"))
        assertEquals("已有内容", appendTranscript("已有内容", "   "))
    }
