...
import github.ponyhuang.gimi.data.agent.permission.LocationPermissionActivity
 ...
 *
 * 对应 [github.ponyhuang.gimi.domain.toolauthorization.model.LocalToolCategory.LOCATION]。
 */
@Singleton
