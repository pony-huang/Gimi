...
import github.ponyhuang.gimi.data.agent.permission.CalendarPermissionActivity
 ...
 *
 * 对应 [github.ponyhuang.gimi.domain.toolauthorization.model.LocalToolCategory.CALENDAR]。
 */
@Singleton
