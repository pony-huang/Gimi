...
class PhoneTool @Inject constructor(private val queue: IntentActionQueue) {
    @Tool(name = "dial_phone_number", description = "Opens the system dialer with a phone number. The user initiates the call.") fun dial(@Param("Phone number to show in the system dialer.") phoneNumber: String): Map<String, Any> {
